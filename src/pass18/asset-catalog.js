...
export const PASS18_ASSETS = Object.freeze([
  ...
  item('castle.bridge.corner', 'kenneyCastle', 'bridge-corner.glb', 'Structures', 'Castle Bridge Corner'),
  item('castle.gate.complex', 'kenneyCastle', 'gate-complex.glb', 'Structures', 'Castle Gate'),
