...
# Widen the opening meadow connector so later elevated ridge geometry cannot create a false gap.
...
# Replace the experimental angled Riverworks connector with broad, overlapping real grass terraces.
...
# If a prior post-build revision exists, normalize that version to the terrace geometry as well.
