...
for name in ['app.js','assets.js','enemies.js','power.js','index.html']:
    p=dst/name
    s=p.read_text()
    s=s.replace('pass16','pass17').replace('Pass16','Pass17').replace('PASS 16','PASS 17').replace('16.0.0','17.0.0').replace('Prism Valley','Prism Valley V2')
    p.write_text(s)
...
'''
(dst/'world.js').write_text(WORLD)
print('PASS17A_BUILD_OK')
