...
needle3="""    addRoute({x:10,z:-44,y:5.55},{x:-5,z:-58,y:5.55});addRoute({x:-5,z:-58,y:5.55},{x:-21,z:-73,y:7.8});"""
replacement3="""    terrain('clover-upper-rise-a',[[-10,-55],[2,-57],[1,-66],[-9,-70],[-18,-64],[-18,-58]],6.3,10);\n    terrain('clover-upper-rise-b',[[-17,-61],[-5,-63],[-6,-73],[-17,-78],[-26,-72],[-26,-65]],7.05,11);\n    addRoute({x:10,z:-44,y:5.55},{x:-5,z:-58,y:5.55});addRoute({x:-5,z:-58,y:5.55},{x:-10,z:-62,y:6.3});addRoute({x:-10,z:-62,y:6.3},{x:-15,z:-67,y:7.05});addRoute({x:-15,z:-67,y:7.05},{x:-21,z:-73,y:7.8});"""
if needle3 not in ws: raise SystemExit('Clover upper-rise anchor not found')
ws=ws.replace(needle3,replacement3)

needle4="""    addRoute({x:-21,z:-73,y:7.8},{x:3,z:-67,y:8.2});addRoute({x:3,z:-67,y:8.2},{x:20,z:-57,y:8.55});"""
replacement4="""    terrain('clover-ruin-link',[[-25,-79],[5,-74],[10,-66],[3,-59],[-22,-66],[-29,-73]],8.0,11);\n    addRoute({x:-21,z:-73,y:7.8},{x:3,z:-67,y:8.0});addRoute({x:3,z:-67,y:8.0},{x:8,z:-64,y:8.2});addRoute({x:8,z:-64,y:8.2},{x:20,z:-57,y:8.55});"""
if needle4 not in ws: raise SystemExit('Clover/Ruin link anchor not found')
ws=ws.replace(needle4,replacement4)
